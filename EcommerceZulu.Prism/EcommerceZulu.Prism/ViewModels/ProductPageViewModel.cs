...
using EcommerceZulu.Prism.ItemViewModel;
...
namespace EcommerceZulu.Prism.ViewModels
{
    public class ProductPageViewModel : ViewModelBase
    {
        ...
        public ProductPageViewModel(INavigationService navigationService, IApiService apiService)
