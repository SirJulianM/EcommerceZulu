...
namespace EcommerceZulu.web.Migrations
{
    ...
    [Migration("20200825191325_DeleteCascadeForCountries")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.City", b =>
                {
                    b.HasOne("EcommerceZulu.Common.Entities.Department", "Department")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("EcommerceZulu.Common.Entities.Department", b =>
                {
                    b.HasOne("EcommerceZulu.Common.Entities.Country", "Country")
            ...
            modelBuilder.Entity("EcommerceZulu.web.Data.DataEntities.User", b =>
                {
                    b.HasOne("EcommerceZulu.Common.Entities.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EcommerceZulu.web.Data.DataEntities.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
